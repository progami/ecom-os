...
const EditableNumberCell = ({ 
  ...
  return (
    <Input
      ...
      className={cn(
        "w-full h-8 text-sm transition-all duration-200 tabular-nums",
...
const EditableTextCell = ({ 
  ...
  return (
    <Input
      ...
      onFocus={() => setIsFocused(true)}
      className={cn(
        "w-full h-8 text-sm transition-all duration-200",
        "hover:border-primary/50 focus:border-primary",
        isFocused && "ring-2 ring-primary/20"
      )}
    />
...
export const SimulationGrid = forwardRef<SimulationGridHandle, SimulationGridProps>(({ 
  materials, 
  sourcingProfiles,
  onCalculate,
    ...
    () => [
      ...
      },
      {
        ...
        header: () => (
          <Tooltip>
            <TooltipTrigger asChild>
              <span className="cursor-help border-b border-dotted border-muted-foreground">Name</span>
            </TooltipTrigger>
            <TooltipContent>
              <p>Scenario name for easy identification</p>
            </TooltipContent>
          </Tooltip>
        ),
      ...
      },
      {
        ...
        header: () => (
          <Tooltip>
            ...
            <TooltipContent>
              <p>Product selling price on Amazon</p>
              <p className="text-xs text-muted-foreground">Before any discounts or promotions</p>
            </TooltipContent>
          </Tooltip>
        ),
      ...
      },
      {
        ...
        header: () => (
          <Tooltip>
            <TooltipTrigger asChild>
              <span className="cursor-help border-b border-dotted border-muted-foreground">Pack Size</span>
            </TooltipTrigger>
            <TooltipContent>
              <p>Number of units per package</p>
              <p className="text-xs text-muted-foreground">Used for unit cost calculations</p>
            </TooltipContent>
          </Tooltip>
        ),
        cell: EditableNumberCell,
      ...
      },
      {
        ...
        header: () => (
          <Tooltip>
            <TooltipTrigger asChild>
              <span className="cursor-help border-b border-dotted border-muted-foreground">Material Profile</span>
            </TooltipTrigger>
            <TooltipContent>
              <p>Product material costs and specs</p>
              <p className="text-xs text-muted-foreground">Includes material, packaging, and labor costs</p>
            </TooltipContent>
          </Tooltip>
        ),
      ...
      },
      {
        ...
        header: () => (
          <Tooltip>
            <TooltipTrigger asChild>
              <span className="cursor-help border-b border-dotted border-muted-foreground">Sourcing Profile</span>
            </TooltipTrigger>
            <TooltipContent>
              <p>Supplier and logistics configuration</p>
              <p className="text-xs text-muted-foreground">MOQ, lead times, and shipping details</p>
            </TooltipContent>
          </Tooltip>
        ),
