...
async function testBankSummaryDirect() {
  try {
    console.log('=== Testing Bank Summary Report Direct ===\n');
    ...
    if (!user.xeroAccessToken || !user.xeroRefreshToken) {
    ...
    const xeroClient = new XeroClient({
      ...
      scopes: 'accounting.reports.read accounting.transactions accounting.settings accounting.contacts accounting.journals.read'.split(' ')
    });
