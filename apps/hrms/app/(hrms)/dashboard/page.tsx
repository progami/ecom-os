            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card padding="lg">
                ...
                <div className="space-y-4">
                  ...
                  <InfoItem icon={PhoneIcon} label="Phone" value={currentEmployee.phone || '—'} />
                </div>
              </Card>
        ...
        {activeTab === 'leave' && (
          <div className="space-y-6">
            ...
            {data?.isManager &&
              ...
              data.leaveApprovalHistory.length > 0 && (
                <Card padding="lg">
                  <h3 className="text-sm font-semibold text-gray-900 mb-4">
            ...
            <Card padding="lg">
              ...
              {leaveLoading ? (
                ...
                <LeaveHistoryTable requests={leaveRequests} onCancel={handleCancelLeave} />
              )}
            </Card>
          </div>
        )}
            ...
            <div className="divide-y divide-gray-100 max-h-[40vh] overflow-y-auto">
              {data.notifications.map((notification) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div
                      className={`mt-0.5 flex-shrink-0 ${notification.isRead ? 'text-gray-400' : 'text-amber-500'}`}
                    >
                      {notification.isRead ? (
