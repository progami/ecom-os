...
const addParticipantRoleOptions = participantRoleOptions.filter(
  (opt) => opt.value !== 'SUBJECT' && opt.value !== 'ASSIGNEE',
);
...
function formatEnum(value: unknown, fallback = '—') {
...
export default function CaseDetailPage() {
  ...
  const [attachmentVisibility, setAttachmentVisibility] = useState<
    'INTERNAL_HR' | 'EMPLOYEE_AND_HR'
  >('INTERNAL_HR');
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  {Boolean(
                    (me?.isHR || me?.isSuperAdmin) &&
                      ...
                      closingStatuses.has(caseForm.status),
                  ) && (
                  ...
                  <div className="mt-5 pt-5 border-t border-gray-200">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <SelectField
                        ...
                        onChange={(e) =>
                          setTaskForm((p) => ({ ...p, assignedToId: e.target.value }))
                        }
                        disabled={taskSaving}
                      />
