...
function AddViolationForm() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(e.message || 'Failed to raise violation')
    } finally {
      setSubmitting(false)
    }
  }
      ...
      <form onSubmit={onSubmit} className="space-y-8">
        <FormSection title="Incident Details">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <SelectField label="Severity" name="severity" required options={severityOptions} placeholder="Select severity..." />
            <SelectField
            ...
            />
            <FormField label="Incident Date" name="incidentDate" type="date" required />
            <SelectField
              label="Reported By"
              name="reportedBy"
              required
        ...
        <FormSection title="Incident Description">
          <div className="space-y-5">
            <TextareaField label="Description" name="description" required rows={4} placeholder="Detailed description of the incident..." />
            <FormField label="Witnesses" name="witnesses" placeholder="Names of witnesses (if any)" />
            <FormField label="Evidence" name="evidence" placeholder="Reference to evidence (file names, locations)" />
          </div>
        </FormSection>
