...
const STEPS: StepDef[] = [
  ...
  },
  {
    ...
    description: 'Create a forecast from any imported series, choose a model, and set a horizon.',
    href: '/forecasts',
    icon: BarChart3,
  },
  {
    ...
    step: 'Optional',
    title: 'Model library',
    description: 'See which models Kairos supports now (Prophet, ETS) and what’s coming next.',
    href: '/models',
    icon: Sparkles,
  },
];
