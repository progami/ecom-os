  ...
  return (
    <div className="space-y-6">
      <div className="space-y-1">
        ...
        <p className="text-body">Choose how Kairos generates and blends forecasts.</p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="text-sm text-muted-foreground">
              Prophet is the default Kairos model today. Create a forecast to run it against any imported time series.
            </div>
