    ...
    <div className="space-y-8 animate-in">
      <div className="space-y-2">
        ...
        <p className="text-body max-w-2xl">
          Models are applied per forecast. Use this page as a reference for what Kairos supports today (Prophet, ETS) and what’s coming next.
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="group relative overflow-hidden transition-all hover:shadow-soft-lg dark:hover:shadow-[0_8px_32px_rgba(0,194,185,0.08)]">
          ...
          <CardHeader className="relative space-y-3">
            <div className="flex items-start justify-between gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-brand-teal-500/10 to-brand-teal-600/10 dark:from-brand-cyan/10 dark:to-brand-teal-600/10">
                <BarChart3 className="h-5 w-5 text-brand-teal-600 dark:text-brand-cyan" aria-hidden />
              </div>
              <Badge variant="success">Available</Badge>
            </div>
            <div className="space-y-1">
              <CardTitle className="text-lg">ETS (Auto)</CardTitle>
              <CardDescription>
                Automatic exponential smoothing model selection (Holt-Winters family).
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent className="relative space-y-4">
            <div className="space-y-2 text-sm text-slate-600 dark:text-slate-400">
              ...
              <div className="flex items-center gap-2">
                <Zap className="h-3.5 w-3.5 text-brand-teal-500 dark:text-brand-cyan" aria-hidden />
                <span>Automatic model selection (spec: ZZZ)</span>
              </div>
              <div className="flex items-center gap-2">
                <Zap className="h-3.5 w-3.5 text-brand-teal-500 dark:text-brand-cyan" aria-hidden />
                <span>Prediction intervals (configurable)</span>
              </div>
            </div>
            <Button asChild className="w-full gap-2">
              <Link href="/forecasts">
