    ...
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-xl border">
        <div className="px-6 py-4 border-b bg-secondary">
          ...
          <p className="text-sm text-muted-foreground mt-1">Upload supporting documents (Max 5MB per file)</p>
        </div>
        
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Proof of Pickup */}
        <div className="border rounded-lg p-4 bg-secondary hover:shadow-soft transition-shadow">
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">BOL, pickup receipt</p>
            </div>
          </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 flex-1 min-w-0">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-sm text-foreground truncate">{proofOfPickup.name}</p>
                    <p className="text-xs text-muted-foreground">{formatFileSize(proofOfPickup.size)}</p>
                  </div>
                </div>
        ...
        <div className="border rounded-lg p-4 bg-secondary hover:shadow-soft transition-shadow">
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Additional supporting documents</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="upload-container">
              <label htmlFor="other-documents-upload" className="cursor-pointer block">
                ...
                >
                  <Plus className="h-5 w-5 text-muted-foreground mx-auto" />
                  <p className="text-xs text-muted-foreground mt-1">Add more documents</p>
                </div>
              </label>
              <input
