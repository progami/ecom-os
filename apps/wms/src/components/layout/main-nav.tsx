...
export function MainNav() {
 ...
 <span className={cn("text-xl font-bold text-slate-900 transition-all duration-300", isTabletCollapsed && "md:hidden lg:inline")}>Talos WMS</span>
 </Link>
 </div>
 ...
 {/* Dropdown menu */}
 {userMenuOpen && (
 <div className="absolute right-0 top-full mt-1 w-56 bg-white rounded-lg shadow-soft-lg border border-slate-200 py-1 z-50">
 ...
 className="hidden md:block lg:hidden p-1.5 rounded-lg hover:bg-slate-100 transition-colors"
 >
 ...
 {section.title && (
 <div className={cn(
 "px-2 pb-1 pt-2 text-xs font-bold uppercase tracking-[0.1em] text-cyan-700/70 transition-all duration-300",
 isTabletCollapsed && "md:hidden lg:block"
 )}>
 {section.title}
 </div>
 ...
 <span className="text-xl font-bold text-slate-900 ">Talos WMS</span>
 </Link>
 </div>
 ...
 <li key={sectionIdx}>
 {section.title && (
 <div className="px-2 pb-2 text-xs font-bold uppercase tracking-[0.1em] text-cyan-700/70 ">
 {section.title}
 </div>
 )}
 <ul role="list" className="space-y-1">
