        ...
        <PageContent>
          ...
          <div className="space-y-2">
            ...
            <div className="text-center py-12 bg-secondary rounded-lg">
              ...
              <p className="text-muted-foreground">No invoices found for reconciliation</p>
            </div>
          ) : (
                  ...
                  <div className={`px-6 py-4 ${
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-sm text-foreground">Total Variance</p>
                          ...
                          <tbody className="divide-y">
                            {invoice.reconciliations.map((item) => (
                              <React.Fragment key={item.id}>
                                ...
                                {expandedItems.has(item.id) && (
                                  <tr>
                                    <td colSpan={7} className="bg-secondary px-8 py-4">
                                                ...
                                                <tr key={detail.id} className="hover:bg-white">
                                                  ...
                                                  <td className="py-1">
                                                    <div>
                                                      ...
                                                      <div className="text-xs text-muted-foreground">{detail.calculatedCost.sku.description}</div>
                                                    </div>
                                                  </td>
