          ...
          <div className="grid gap-1 md:grid-cols-2">
            {reports.filter(r => r.featured).map((report, index) => (
              ...
              >
                ...
                <p className="text-sm text-foreground mb-4">{report.description}</p>
        ...
        <div>
          ...
          <div className="grid gap-1 md:grid-cols-3">
            {reports.filter(r => !r.featured).map((report, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <report.icon className="h-8 w-8 text-muted-foreground group-hover:text-primary transition-colors" />
        ...
        <div className="bg-gradient-to-r from-cyan-50 to-brand-teal-50 border border-cyan-200 rounded-lg p-2">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-foreground">Create custom reports with specific filters</p>
            </div>
