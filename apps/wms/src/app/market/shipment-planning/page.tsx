...
export default function ShipmentPlanningPage() {
  ...
  useEffect(() => {
    ...
    if (!session) {
      window.location.href = buildCentralLoginUrl('/market/shipment-planning')
      return
    }
    fetchStockData()
          ...
          actions={
            <div className="flex items-center gap-2">
              <button
                ...
                className="inline-flex items-center px-4 py-2 border border-border rounded-md shadow-soft text-sm font-medium text-foreground bg-white hover:bg-secondary"
              >
              ...
              <button
                ...
                disabled={refreshing}
                className="inline-flex items-center px-4 py-2 border border-border rounded-md shadow-soft text-sm font-medium text-foreground bg-white hover:bg-secondary disabled:opacity-50"
              >
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 border-l pl-4">
              <button
                ...
                className={`p-2 rounded ${viewMode === 'table' ? 'bg-muted' : 'hover:bg-muted'}`}
                title="Table view"
              >
              ...
              <button
                ...
                className={`p-2 rounded ${viewMode === 'cards' ? 'bg-muted' : 'hover:bg-muted'}`}
                title="Card view"
              >
          ...
          <div className="border rounded-lg overflow-hidden">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredStockItems.map((item) => (
                <tr key={item.skuCode} className="hover:bg-secondary">
