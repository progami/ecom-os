      ...
      <DashboardLayout>
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="mt-2 text-muted-foreground">Loading SKU details...</p>
          </div>
        </div>
      </DashboardLayout>
    )
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">
                  SKU Code *
                  <span className="text-xs text-muted-foreground ml-1">(Unique identifier)</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">
                  ASIN
                  <span className="text-xs text-muted-foreground ml-1">(Amazon Standard ID)</span>
                </label>
                <input
                  type="text"
                  value={formData.asin}
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-foreground mb-1">
                  Description *
                  <span className="text-xs text-muted-foreground ml-1">(Product name/description)</span>
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">
                  Pack Size *
                  <span className="text-xs text-muted-foreground ml-1">(Units per pack)</span>
                </label>
                <input
                  type="number"
                  min="1"
          ...
          <div className="bg-white border rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">
                  Unit Dimensions (cm)
                  <span className="text-xs text-muted-foreground ml-1">(L x W x H)</span>
                </label>
          ...
          <div className="bg-white border rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">
                  Units per Carton *
                  <span className="text-xs text-muted-foreground ml-1">(For warehouse operations)</span>
                </label>
                <input
                  type="number"
                  min="1"
