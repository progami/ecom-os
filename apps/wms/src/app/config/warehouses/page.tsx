...
function WarehouseAndRatesPageContent() {
 ...
 <p className="text-sm text-slate-500 mt-1">Showing {warehouses.length} locations</p>
 </div>
 ...
 {selectedWarehouse && (
 <div className="border rounded-xl bg-white shadow-soft ">
 <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 px-6 py-4 border-b border-slate-200 ">
 <div>
 <div className="flex items-center gap-3">
 ...
 <p className="text-sm text-slate-500 mt-1">Code: {selectedWarehouse.code}</p>
 </div>
 ...
 <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 ">
 <dt className="text-xs font-medium uppercase tracking-wider text-slate-500 ">Cost Rates</dt>
 <dd className="mt-2 text-2xl font-bold text-slate-900 ">
 {selectedWarehouse._count.costRates}
 </dd>
 </div>
 <div className="rounded-xl border border-slate-200 bg-slate-50 p-4 ">
 <dt className="text-xs font-medium uppercase tracking-wider text-slate-500 ">Inventory Txns</dt>
 <dd className="mt-2 text-2xl font-bold text-slate-900 ">
 ...
 <span className="font-medium text-slate-900 ">{selectedWarehouse.contactEmail}</span>
 </li>
 )}
 {selectedWarehouse.contactPhone && (
 <li className="flex items-start gap-2">
 <span className="text-slate-500 ">Phone:</span>
 <span className="font-medium text-slate-900 ">{selectedWarehouse.contactPhone}</span>
 </li>
 )}
 </ul>
 ) : (
 ...
 <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-soft ">
 <p className="text-xs font-medium uppercase tracking-wider text-slate-500 ">Active Rates</p>
 <p className="mt-2 text-3xl font-bold text-slate-900 ">{selectedWarehouseStats.active}</p>
 <p className="mt-1 text-xs text-slate-500 ">Currently applied</p>
 </div>
 <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-soft ">
 <p className="text-xs font-medium uppercase tracking-wider text-slate-500 ">Last Effective</p>
 <p className="mt-2 text-lg font-semibold text-slate-900 ">
 {selectedWarehouseStats.lastUpdated ? formatDate(selectedWarehouseStats.lastUpdated.toISOString()) : 'No rates yet'}
 </p>
 <p className="mt-1 text-xs text-slate-500 ">Most recent start</p>
 </div>
 </div>
...
function _SummaryCard({ title, value, description }: SummaryCardProps) {
 return (
 <div className="bg-white border border-slate-200 rounded-xl px-5 py-4 shadow-soft ">
