...
import { Building, Save, X, Calendar } from '@/lib/lucide-icons'
...
export default function EditWarehouseConfigPage() {
  ...
  useEffect(() => {
    ...
    if (!session || session.user.role !== 'admin') {
      window.location.href = buildCentralLoginUrl(`/config/warehouse-configs/${params.id}/edit`)
      return
    }
    fetchConfig()
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="bg-white border rounded-lg p-6 space-y-6">
          ...
          <div className="bg-secondary rounded-lg p-4 space-y-3">
            <h3 className="font-semibold text-foreground">Configuration Details</h3>
