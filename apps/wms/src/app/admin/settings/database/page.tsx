      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white border rounded-lg p-4">
            ...
            <p className="text-sm text-foreground">Database Size</p>
          </div>
          <div className="bg-white border rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
            ...
            <p className="text-sm text-foreground">Tables</p>
          </div>
          <div className="bg-white border rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <Database className="h-5 w-5 text-muted-foreground" />
            ...
            <p className="text-sm text-foreground">Total Records</p>
          </div>
          <div className="bg-white border rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
            ...
            <p className="text-sm text-foreground">Last Backup</p>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <button
                ...
                disabled={restoring}
                className="inline-flex items-center px-4 py-2 border border-border rounded-md hover:bg-secondary"
              >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => setBackupSchedule(prev => ({ ...prev, frequency: e.target.value as 'daily' | 'weekly' | 'monthly' }))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
              />
              <p className="text-xs text-muted-foreground mt-1">Maximum number of database connections</p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
              />
              <p className="text-xs text-muted-foreground mt-1">Maximum query execution time</p>
            </div>
          </div>
