      ...
      <div className="max-w-md w-full space-y-8 text-center">
        <div>
          ...
          <p className="mt-3 text-base text-slate-600">
            Your account doesn't have permission to access the Warehouse Management System.
          </p>
        </div>
        ...
        <div className="bg-slate-100 rounded-lg p-4 text-left">
          ...
          <ul className="text-sm text-slate-600 space-y-1.5">
            <li className="flex items-start gap-2">
              ...
              <span>You're signed in but WMS access hasn't been granted to your account</span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-slate-400 mt-0.5">•</span>
