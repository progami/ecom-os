  ...
  return (
    <DashboardLayout>
      <PageContainer>
        ...
        {/* Variance Table */}
        <div className="overflow-hidden rounded-xl border border-border bg-card shadow-soft dark:border-[#0b3a52] dark:bg-[#06182b]">
          <div className="border-b border-border bg-secondary px-6 py-3 dark:border-[#0b3a52] dark:bg-[#041324]">
          ...
          <div className="overflow-x-auto">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredVariances.map((variance) => (
                <tr key={variance.id} className="hover:bg-secondary">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">{variance.sku.description}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm">
                    {variance.batchLot}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-center">
                    <div className={`inline-flex items-center gap-1 font-medium ${
                      variance.variance > 0 ? 'text-green-600' : variance.variance < 0 ? 'text-red-600' : 'text-foreground'
                    }`}>
                      {variance.variance > 0 ? (
