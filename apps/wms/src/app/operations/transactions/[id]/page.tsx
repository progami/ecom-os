            ...
            {isEditMode ? (
              <>
                <button
                  ...
                  className="px-4 py-2 text-sm font-medium text-foreground bg-white border border-border rounded-md hover:bg-secondary"
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-1">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-3 py-2 border border-border rounded-md ${isEditMode ? 'bg-white' : 'bg-secondary'}`}
                    readOnly={!isEditMode}
                  />
                </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-secondary">
                    <tr>
                      ...
                      <th className="px-4 py-2 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Batch/Lot</th>
                      <th className="px-4 py-2 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Cartons</th>
                      <th className="px-4 py-2 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Units</th>
                      {isReceive && (
                        <>
                          <th className="px-4 py-2 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Storage Pallets In</th>
                          <th className="px-4 py-2 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Storage Cartons/Pallet</th>
                          <th className="px-4 py-2 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Shipping Cartons/Pallet</th>
                        </>
                      )}
                      {isShip && (
                        <>
                          <th className="px-4 py-2 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Shipping Pallets Out</th>
                          <th className="px-4 py-2 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Shipping Cartons/Pallet</th>
                        </>
                      )}
                    </tr>
              ...
              {(!transaction.calculatedCosts || transaction.calculatedCosts.length === 0) ? (
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-secondary">
                      <tr>
                        <th className="px-4 py-2 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Cost Category</th>
                        <th className="px-4 py-2 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Cost Name</th>
                        ...
                        <th className="px-4 py-2 text-left text-xs font-medium text-muted-foreground uppercase tracking-wider">Total Cost</th>
                      </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200">
                    ...
                    <div className="p-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {Object.entries(transaction.attachments as Record<string, ApiAttachment | null>).map(([category, attachment]) => {
                          ...
                          return (
                            <div key={category} className="border rounded-lg p-4 bg-secondary">
