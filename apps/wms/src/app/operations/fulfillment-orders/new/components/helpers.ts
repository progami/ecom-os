import type { AmazonInboundShipmentItem, NormalizedInboundItem } from './types'
...
export const normalizeInboundItems = (items: AmazonInboundShipmentItem[]): NormalizedInboundItem[] => {
