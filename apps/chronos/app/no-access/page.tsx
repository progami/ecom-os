    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-12 dark:bg-slate-950">
      <Card className="w-full max-w-md">
        <CardHeader className="items-center text-center">
          ...
          <CardTitle className="mt-4 text-xl">No Access to Chronos</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-3">
          ...
          <Button
            ...
            variant="outline"
            className="w-full"
            aria-label="Request Chronos access via email"
          >
            <a href="mailto:support@targonglobal.com?subject=Chronos%20Access%20Request">
