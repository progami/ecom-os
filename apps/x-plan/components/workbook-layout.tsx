  ...
  const yearSwitcher = useMemo(() => {
    ...
    return (
      <div className={`${SHEET_TOOLBAR_GROUP} gap-0.5`}>
        ...
        <select
          className={`${SHEET_TOOLBAR_SELECT} min-w-[5rem]`}
