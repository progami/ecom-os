...
export function TimeZoneClocks() {
  ...
  return (
    <div className="hidden items-center gap-2 rounded-xl border border-slate-200 bg-white/80 px-2 py-1 text-[10px] font-medium text-slate-600 shadow-sm backdrop-blur dark:border-[#0b3a52] dark:bg-[#06182b]/70 dark:text-slate-300 sm:flex">
