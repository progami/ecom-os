    ...
    for (const review of pendingHrReviews) {
      ...
      items.push({
        ...
        entityData: {
          ...
          employeeNameForReview: `${review.employee.firstName} ${review.employee.lastName}`,
        },
  ...
  for (const leave of approvedLeaves) {
    items.push({
      ...
      entityData: {
        ...
        startDate: iso(leave.startDate),
        endDate: iso(leave.endDate),
      },
