-- Checklist engine (templates + instances) and singleton ATLAS settings.
...
-- ATLAS settings (singleton row)
CREATE TABLE "AtlasSettings" (
  ...
  CONSTRAINT "AtlasSettings_pkey" PRIMARY KEY ("id")
);

CREATE INDEX "AtlasSettings_defaultHROwnerId_idx" ON "AtlasSettings"("defaultHROwnerId");
CREATE INDEX "AtlasSettings_defaultITOwnerId_idx" ON "AtlasSettings"("defaultITOwnerId");

ALTER TABLE "AtlasSettings"
ADD CONSTRAINT "AtlasSettings_defaultHROwnerId_fkey"
FOREIGN KEY ("defaultHROwnerId") REFERENCES "Employee"("id")
ON DELETE SET NULL
ON UPDATE CASCADE;

ALTER TABLE "AtlasSettings"
ADD CONSTRAINT "AtlasSettings_defaultITOwnerId_fkey"
