  ...
  try {
    line = await prisma.purchaseOrderLine.create({
      data: {
        ...
        cartonLengthCm: existingBatch.cartonLengthCm ?? sku.cartonLengthCm ?? null,
        cartonWidthCm: existingBatch.cartonWidthCm ?? sku.cartonWidthCm ?? null,
        cartonHeightCm: existingBatch.cartonHeightCm ?? sku.cartonHeightCm ?? null,
