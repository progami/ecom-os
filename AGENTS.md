...
All testing should be done via Chrome browser directly to `https://targonos.targonglobal.com/<app>` (e.g., `https://targonos.targonglobal.com/x-plan`). Do not test on localhost.
