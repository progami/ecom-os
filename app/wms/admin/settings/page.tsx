...
import { PageHeader, HelpfulTips } from '@/components/wms/ui/page-header'
...
export default function AdminSettingsPage() {
  ...
  const handleExportData = async () => {
    setLoading('export')
    try {
      const response = await fetch('/api/v1/wms/export/all-data', {
        method: 'GET',
      })
