...
import { PageHeader } from '@/components/wms/ui/page-header'
...
export default function AdminDashboardPage() {
  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      const response = await fetch(`/api/v1/wms/admin/dashboard?${params}`)
  ...
  const handleExportData = async (e?: React.MouseEvent) => {
    ...
    setLoading('export')
    try {
      const response = await fetch('/api/v1/wms/export?type=all', {
        method: 'GET',
      })
        ...
        <div className="border rounded-lg p-6 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <SystemAction
              ...
              onClick={() => router.push('/wms/admin/reports')}
            />
            <SystemAction
              title="System Health"
            ...
            <SystemAction
              ...
              icon={Bell}
              onClick={() => router.push('/wms/admin/settings/notifications')}
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <QuickActionCard
              ...
              icon={Warehouse}
              href="/wms/admin/settings/warehouses"
              color="bg-orange-500"
            />
            <QuickActionCard
