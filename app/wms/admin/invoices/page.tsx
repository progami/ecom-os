            ...
            <tbody className="bg-white divide-y divide-gray-200">
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <Link href="/wms/admin/invoices/INV-2025-001" className="text-primary hover:underline">
                    Review
                  </Link>
                </td>
              </tr>
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <Link href="/wms/admin/invoices/INV-2024-089" className="text-primary hover:underline">
                    View
                  </Link>
                </td>
              </tr>
              <tr className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <Link href="/wms/admin/invoices/INV-2024-088" className="text-primary hover:underline">
                    Resolve
                  </Link>
                </td>
              </tr>
