...
// GET /api/v1/wms/settings/notifications - Get notification settings
export async function GET() {
  try {
    ...
    const settings = await prisma.wmsSettings.findFirst({
...
// POST /api/v1/wms/settings/notifications - Save notification settings
