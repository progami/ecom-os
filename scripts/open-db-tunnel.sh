...
# can connect via localhost:6543. Requires the `ecomos` host entry in ~/.ssh/config.

PORT=${DB_TUNNEL_PORT:-6543}
RDS_HOST=${RDS_HOST:-ecomos-prod.cyx0i8s6srto.us-east-1.rds.amazonaws.com}
RDS_PORT=${RDS_PORT:-5432}
BASTION_HOST=${BASTION_HOST:-ecomos}
